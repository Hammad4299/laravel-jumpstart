 ...
 */
var elem = document.getElementById('site-configs');
var _rollbarConfig = {
    accessToken: elem.dataset.rollbarToken,
    captureUncaught: true,
    captureUnhandledRejections: true,

    //SourceMaps
    payload: {
        environment: elem.dataset.environment,
        client: {
            javascript: {
                source_map_enabled: true, //this is now true by default
                code_version: "IMPORTANT!!!! set dynamic code version here",
        ...
        if (trace && trace.frames) {
            for (var i = 0; i < trace.frames.length; i++) {
                ...
                if (filename) {
                    ...
                    trace.frames[i].filename = m[1] + '://#{rollbar_dhost}' + m[2];
                }
            }
        }
    }
